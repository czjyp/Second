...
import com.tt.czj.photogallery.activity.AlbumActivity;
import com.tt.czj.photogallery.activity.ShowAllPhoto;
...
//			holder.imageView.setImageBitmap( AlbumActivity.contentList.get(position).imageList.get(0).getBitmap());
	...
	private class ImageViewClickListener implements OnClickListener {
        ...
        /**
         * Instantiates a new Image view click listener.
         *
         * @param position    the position
         * @param intent      the intent
         * @param choose_back the choose back
         */

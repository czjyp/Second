...
public class AlbumHelper {
    ...
    /**
     * The Has build images bucket list.
     */
    boolean hasBuildImagesBucketList = false;

    /**
     * Build images bucket list.
     */
    ...
    /**
     * Gets images bucket list.
     *
     * @param refresh the refresh
     * @return the images bucket list
     */
